import * as NEJ from "./global";
import * as _g from "./constant";
import * as _u from "./util";
import * as _v from "./event";
import * as _x from "./chain";
import * as _h from "./platform/element";
var _p = {};
var _o = {};
var _f = function () {};
var _r = [];
...
_p._$id = _y._$id = function (_element) {
    ...
    _element.id = _id; // check if element can be getted
    if (!_p._$get(_id)) {
        _dirty[_id] = _element;
    }
    return _id;
...
_p._$getMaxBox = function (_org, _max) {
    var _result = _u._$merge({}, _org),
        ...
        _orto = _org.width / _org.height; // height overflow
...
// clear events
            ...
            _doClear(_element, 'iframe'); // remove node
...
_p._$wrapInline = _y._$wrapInline = function () {
    ...
    return function (_element, _options) {
        ...
        _doInitStyle();
        _options = _options || _o; // check relative parent
